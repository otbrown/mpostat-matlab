...
% 2016-03-22
%
% [ updateBlock ] = GrowLeft(siteTensor, mpo, leftBlock, ...
%                               ROW_SIZE, COL_SIZE, HILBY, OP_COL)
%
% RETURN
% updateBlock:  complex double, rank-3, contraction from the first site
%               in the system through to the specified site
%
% INPUT
% siteTensor:   complex double, rank-4, the dmpo tensor for the specified
%               site -- to be included in the contraction from the first
%               site in the system
% mpo:          complex double, rank-6, mpo tensor for the operator which
%               is being evaluated in <rho|| O ||rho>
% leftBlock:    complex double, rank-3, the contraction from the first
%               site through to the site immediately before the specified
%               site -- if the specified site is the first, then leftBlock
%                = 1
